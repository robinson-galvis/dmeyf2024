...
dir.create("D:/Robin/DMEyF/exp/HT2810/", showWarnings = FALSE)
setwd( "D:/Robin/DMEyF/exp/HT2810/" )
...
for (vmax_depth in c(4, 6, 8, 10, 12, 14)) {
  for (vmin_split in c(1000, 800, 600, 400, 200, 100, 50, 20, 10)) {
    for (vmin_bucket in c(50, 100, 150, 200, 250, 300, 350, 400)) {
      for (vcp in c(0.001, 0.01, 0.1, 0.2, 0.5, 1.0)) {
        ...
        # Un solo llamado con todas las semillas
        ganancias <- ArbolesMontecarlo(PARAM$semillas, param_basicos)
