...
PARAM$semilla_primigenia <- 881269 # 102191
...
hs <- makeParamSet(
  ...
  makeIntegerParam("max_depth", lower = 7L, upper = 15L),
  makeIntegerParam("lambda_l1", lower = 0.0, upper = 10.0),
  makeIntegerParam("lambda_l2", lower = 0.0, upper = 10.0)
)
