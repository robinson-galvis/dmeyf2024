...
envg$EXPENV$semilla_primigenia <- 881269 #102191
...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(
    ...
    202005, 
    # 202004, 202003, Meses con información inconsistente
    202002, 202001,
    201912, 201911,
...
wf_semillero_rf_a25_cn_r1_d0_sinB1_sin202004_03_sem881269 <- function( pnombrewf )
{
  param_local <- exp_wf_init( pnombrewf ) # linea fija

  # Etapa especificacion dataset de la Segunda Competencia Kaggle
  DT_incorporar_dataset( "~/buckets/b1/datasets/competencia_02_Sin_Baja1.csv.gz")
...
wf_semillero_rf_a25_cn_r1_d0_sinB1_sin202004_03_sem881269()
